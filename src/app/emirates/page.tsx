...
export default function EmiratesGrassPage() {
  ...
  console.log("🌱 Emirates", {
    pitch: (flatData as any).pitch,
    sections: flatData.sections.length,
    scale,
  });
  ...
  return (
    <div style={{ width:"100vw",height:"100vh",position:"relative" }}>
        ...
        <Stage width={stageSize.width} height={stageSize.height}>
          <Layer>
            <Group x={gx} y={gy} scaleX={scale} scaleY={scale}>
              ...
              <StadiumPitch config={(flatData as any).pitch} scale={scale} />
              {/* Sections on top */}
      ...
      <div style={{ position:"absolute",bottom:24,left:24,right:24,display:"flex",justifyContent:"space-between" }}>
        ...
        <a href="/bernabeu" style={{ color:"#94a3b8",fontSize:12,fontWeight:700,textDecoration:"none",background:"rgba(255,255,255,0.05)",padding:"6px 14px",borderRadius:8,border:"1px solid rgba(255,255,255,0.1)" }}>Bernabéu</a>
      </div>
    </div>
  );
}
